...
private nonisolated(unsafe) let SPRING_CONFIG = SpringInterpolation.Configuration(
  angularFrequency: 1.5,
  dampingRatio: 0.2,
  threshold: 0.0001,
  stopWhenHitTarget: true,
)
private nonisolated(unsafe) let SPRING_ENGINE = SpringInterpolation2D(SPRING_CONFIG)
