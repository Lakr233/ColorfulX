...
import Foundation
@preconcurrency import SpringInterpolation

extension AnimatedMulticolorGradientView {
  public struct Speckle {
...
extension AnimatedMulticolorGradientView {
  public func setColors(_ colors: [ColorVector], animated: Bool = true, repeats: Bool = true) {
    var colors = colors
...
extension AnimatedMulticolorGradientView {
  public func setColors(_ preset: ColorfulPreset, animated: Bool = true, repeats: Bool = true) {
    setColors(
  ...
  public func setColors(_ preset: ColorfulColors, animated: Bool = true, repeats: Bool = true) {
    setColors(
      preset.colors.map { ColorVector($0) },
      animated: animated,
      repeats: repeats,
  ...
  public func setColors(_ colors: [ColorElement], animated: Bool = true, repeats: Bool = true) {
    setColors(
